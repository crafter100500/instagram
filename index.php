  ...
  <body>
	...
	<div class="col-6 mx-auto" > <!--ГЛАВНЫЙ БЛОК-->
		<form action="update.php" method="GET">
			<input type="" name="id" placeholder="ID" class=" border rounded text-center px-3 ml-5 border-secondary">
			<input type="" name="text" placeholder="Text" class=" border rounded text-center px-3 ml-5 border-secondary">
			<input type="" name="img" placeholder="Img" class=" border rounded text-center px-3 ml-5 border-secondary">
			<button class="btn-primary btn ">Обновить</button>
		</form>
		<div class="row"> 
